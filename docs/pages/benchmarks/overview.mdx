...
- benchmark configs and outputs: [benchmarks/](https://github.com/asyncswap/solidity-language-server/tree/main/benchmarks)
- docs-rendered report pages: [docs/pages/benchmarks/reports/](https://github.com/asyncswap/solidity-language-server/tree/main/docs/pages/benchmarks/reports)
