...
| [Claude Code](/agents/claude) | Via [plugin](https://github.com/mmsaki/solidity-language-server-plugin) | `CLAUDE.md` | Automatic via LSP | Hover, definition, references, symbols, call hierarchy |
...
Claude Code supports LSP through its plugin system. Install the [solidity-language-server plugin](https://github.com/mmsaki/solidity-language-server-plugin) to get full LSP integration — hover, go-to-definition, references, symbols, and call hierarchy — all through the LSP tool.
