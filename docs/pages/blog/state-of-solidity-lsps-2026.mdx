...
| Server | Language | Maintainer |
|--------|----------|------------|
| [solidity-language-server](https://github.com/mmsaki/solidity-language-server) | Rust | mmsaki |
| [solc --lsp](https://docs.soliditylang.org/) | C++ | Solidity team |
| [nomicfoundation-solidity-ls](https://github.com/NomicFoundation/hardhat-vscode) | TypeScript | Nomic Foundation |
| [vscode-solidity](https://github.com/juanfranblanco/vscode-solidity) | TypeScript | Juan Blanco |
| [solidity-ls (qiuxiang)](https://github.com/qiuxiang/solidity-ls) | TypeScript | qiuxiang |
...
- **solc --lsp** returns results for diagnostics but leaves most LSP methods unimplemented or empty.
...
The Solidity language server ecosystem in 2026 has a clear performance leader. On real-world codebases, most existing servers either time out or crash. solidity-language-server is the only one that handles production-scale Solidity projects with sub-15ms latency across the full LSP feature set.

The benchmarks are open. The tool is open. Try it on your codebase and see for yourself.
